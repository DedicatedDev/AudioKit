...
public class Compressor: Node {
    ...
    public static let thresholdDef = NodeParameterDef(
        ...
        name: "Threshold",
        address: akGetParameterAddress("CompressorParameterThreshold"),
        defaultValue: -20,
        range: -40 ... 20,
        unit: .decibels)
    ...
    public static let headRoomDef = NodeParameterDef(
        identifier: "headRoom",
        name: "Head Room",
        address: akGetParameterAddress("CompressorParameterHeadRoom"),
        defaultValue: 5,
        range: 0.1 ... 40.0,
        unit: .decibels)
    ...
    public static let attackTimeDef = NodeParameterDef(
        ...
        name: "Attack Time",
        address: akGetParameterAddress("CompressorParameterAttackTime"),
        defaultValue: 0.001,
        range: 0.0001 ... 0.2,
        unit: .seconds)
    ...
    public static let releaseTimeDef = NodeParameterDef(
        ...
        name: "Release Time",
        address: akGetParameterAddress("CompressorParameterReleaseTime"),
        defaultValue: 0.05,
        range: 0.01 ... 3,
        unit: .seconds)
    ...
    public static let masterGainDef = NodeParameterDef(
        ...
        name: "Master Gain",
        address: akGetParameterAddress("CompressorParameterMasterGain"),
        defaultValue: 0,
        range: -40 ... 40,
        unit: .decibels)
